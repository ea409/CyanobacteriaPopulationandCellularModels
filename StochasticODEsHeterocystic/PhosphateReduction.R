...
colnames(nitrogenlow2) = c("Day","N.Level", "Nitrogen", "Cells", "Carbon", "Phosphate", "External.Phosphate")
colnames(nitrogenmed2) = c("Day","N.Level", "Nitrogen", "Cells", "Carbon", "Phosphate", "External.Phosphate")
colnames(nitrogenhigh2) = c("Day" ,"N.Level", "Nitrogen", "Cells", "Carbon", "Phosphate", "External.Phosphate")

resultN <- bind_rows(nitrogenhigh2, nitrogenmed2, nitrogenlow2)

pN <- ggplot(resultN, aes(Day, Cells, color  = N.Level))
pN+geom_point() + scale_color_manual(values = GrandBudapest + ggtitle("Latitude Effect")