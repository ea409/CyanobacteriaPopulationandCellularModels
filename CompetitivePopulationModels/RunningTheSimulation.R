...
Birthrateheterotroph <- 0.79*(LakeSPhosphate/(LakeSPhosphate+4))*(LakeSNitrogen/(LakeSNitrogen+4))*(LakeSLight/(LakeSLight+2.5))
Birthratespatial <- 2*(LakeSPhosphate/(LakeSPhosphate+11.5))*(LakeSNitrogen/(LakeSNitrogen+10))*(LakeSLight/(LakeSLight+3.98))
Birthratetemporal <- 0.75*(LakeSPhosphate/(LakeSPhosphate+8))*(LakeSNitrogen/(LakeSNitrogen+0.5))*(LakeSLight/(LakeSLight+4.03))
