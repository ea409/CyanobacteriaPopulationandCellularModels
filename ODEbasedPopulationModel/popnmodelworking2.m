...
% Parameters
rN = 40e-2;     % Rate of nitrogen consumption
rC = 120e-3;     % Rate of carbon consumption
...
dydt(3) = rp*circadian*ZL - rC*V1*Z - 2*a*V1*(1-circadian)*((C1/(C1+k))) - rCC*V1*(C1/(kCC + C1));    % C1
